...
var AugmentationConverter = function() {
    ...
    var generateDrawable2DOptions = function(augmentation) {
        ...
        if (augmentation.properties.translate) {
            object.translate = augmentation.properties.translate;
        }

        if (augmentation.properties.scale) {
            object.scale = augmentation.properties.scale;
        }

        if (augmentation.properties.rotate) {
            object.rotate = {
                x: augmentation.properties.rotate.x,
                y: augmentation.properties.rotate.y,
                z: augmentation.properties.rotate.z
            };
        }
        return object;
    };
    ...
    var convertModel = function(model, listener, signal) {
        ...
        var drawable = new AR.Model(model.uri, {
            ...
            rotate: {
                x: model.properties.rotate.x,
                y: -model.properties.rotate.y,
                z: -model.properties.rotate.z
            },
